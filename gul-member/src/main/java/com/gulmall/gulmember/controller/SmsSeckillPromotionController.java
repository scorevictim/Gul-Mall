...
import com.gulmall.gulmember.excel.SmsSeckillPromotionExcel;
 ...
 */
@RestController
@RequestMapping("gulmember/smsseckillpromotion")
@Api(tags="秒杀活动")
public class SmsSeckillPromotionController {
    ...
    @RequiresPermissions("gulmember:smsseckillpromotion:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulmember:smsseckillpromotion:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulmember:smsseckillpromotion:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulmember:smsseckillpromotion:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulmember:smsseckillpromotion:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulmember:smsseckillpromotion:export")
