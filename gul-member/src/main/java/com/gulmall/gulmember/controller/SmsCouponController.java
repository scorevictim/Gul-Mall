...
import com.gulmall.gulmember.excel.SmsCouponExcel;
 ...
 */
@RestController
@RequestMapping("gulmember/smscoupon")
@Api(tags="优惠券信息")
public class SmsCouponController {
    ...
    @RequiresPermissions("gulmember:smscoupon:page")
    public Result<PageData<SmsCouponDTO>> page(@ApiIgnore @RequestParam Map<String, Object> params){
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulmember:smscoupon:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulmember:smscoupon:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulmember:smscoupon:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulmember:smscoupon:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulmember:smscoupon:export")
    public void export(@ApiIgnore @RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        List<SmsCouponDTO> list = smsCouponService.list(params);

        ExcelUtils.exportExcelToTarget(response, null, list, SmsCouponExcel.class);
    }
