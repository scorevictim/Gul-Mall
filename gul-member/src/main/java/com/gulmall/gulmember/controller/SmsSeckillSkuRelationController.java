...
import com.gulmall.gulmember.excel.SmsSeckillSkuRelationExcel;
 ...
 */
@RestController
@RequestMapping("gulmember/smsseckillskurelation")
@Api(tags="秒杀活动商品关联")
public class SmsSeckillSkuRelationController {
    ...
    @RequiresPermissions("gulmember:smsseckillskurelation:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulmember:smsseckillskurelation:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulmember:smsseckillskurelation:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulmember:smsseckillskurelation:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulmember:smsseckillskurelation:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulmember:smsseckillskurelation:export")
