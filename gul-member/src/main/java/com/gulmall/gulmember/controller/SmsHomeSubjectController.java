...
import com.gulmall.gulmember.excel.SmsHomeSubjectExcel;
 ...
 */
@RestController
@RequestMapping("gulmember/smshomesubject")
...
public class SmsHomeSubjectController {
    ...
    @RequiresPermissions("gulmember:smshomesubject:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulmember:smshomesubject:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulmember:smshomesubject:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulmember:smshomesubject:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulmember:smshomesubject:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulmember:smshomesubject:export")
