...
import com.gulmall.gulmember.excel.SmsSeckillSessionExcel;
 ...
 */
@RestController
@RequestMapping("gulmember/smsseckillsession")
@Api(tags="秒杀活动场次")
public class SmsSeckillSessionController {
    ...
    @RequiresPermissions("gulmember:smsseckillsession:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulmember:smsseckillsession:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulmember:smsseckillsession:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulmember:smsseckillsession:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulmember:smsseckillsession:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulmember:smsseckillsession:export")
