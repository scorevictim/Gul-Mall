...
import com.gulmall.gulmember.excel.SmsSkuLadderExcel;
 ...
 */
@RestController
@RequestMapping("gulmember/smsskuladder")
@Api(tags="")
public class SmsSkuLadderController {
    ...
    @RequiresPermissions("gulmember:smsskuladder:page")
    public Result<PageData<SmsSkuLadderDTO>> page(@ApiIgnore @RequestParam Map<String, Object> params){
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulmember:smsskuladder:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulmember:smsskuladder:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulmember:smsskuladder:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulmember:smsskuladder:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulmember:smsskuladder:export")
    public void export(@ApiIgnore @RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        List<SmsSkuLadderDTO> list = smsSkuLadderService.list(params);

        ExcelUtils.exportExcelToTarget(response, null, list, SmsSkuLadderExcel.class);
    }
