...
import com.gulmall.gulmember.excel.SmsHomeSubjectSpuExcel;
 ...
 */
@RestController
@RequestMapping("gulmember/smshomesubjectspu")
@Api(tags="专题商品")
public class SmsHomeSubjectSpuController {
    ...
    @RequiresPermissions("gulmember:smshomesubjectspu:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulmember:smshomesubjectspu:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulmember:smshomesubjectspu:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulmember:smshomesubjectspu:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulmember:smshomesubjectspu:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulmember:smshomesubjectspu:export")
