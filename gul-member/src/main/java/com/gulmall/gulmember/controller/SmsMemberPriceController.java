...
import com.gulmall.gulmember.excel.SmsMemberPriceExcel;
 ...
 */
@RestController
@RequestMapping("gulmember/smsmemberprice")
@Api(tags="商品会员价格")
public class SmsMemberPriceController {
    ...
    @RequiresPermissions("gulmember:smsmemberprice:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulmember:smsmemberprice:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulmember:smsmemberprice:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulmember:smsmemberprice:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulmember:smsmemberprice:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulmember:smsmemberprice:export")
