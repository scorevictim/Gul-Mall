...
import com.gulmall.gulmember.excel.SmsCouponSpuRelationExcel;
 ...
 */
@RestController
@RequestMapping("gulmember/smscouponspurelation")
@Api(tags="优惠券与产品关联")
public class SmsCouponSpuRelationController {
    ...
    @RequiresPermissions("gulmember:smscouponspurelation:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulmember:smscouponspurelation:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulmember:smscouponspurelation:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulmember:smscouponspurelation:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulmember:smscouponspurelation:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulmember:smscouponspurelation:export")
