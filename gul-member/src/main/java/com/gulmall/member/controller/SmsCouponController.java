...
import com.gulmall.member.excel.SmsCouponExcel;
 ...
 */
@RestController
@RequestMapping("member/smscoupon")
@Api(tags="优惠券信息")
public class SmsCouponController {
    ...
    @RequiresPermissions("member:smscoupon:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("member:smscoupon:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("member:smscoupon:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("member:smscoupon:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("member:smscoupon:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("member:smscoupon:export")
