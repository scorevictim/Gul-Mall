...
import com.gulmall.member.excel.SmsSeckillSkuNoticeExcel;
...
public class SmsSeckillSkuNoticeController {
    ...
    @RequiresPermissions("member:smsseckillskunotice:page")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("member:smsseckillskunotice:export")
