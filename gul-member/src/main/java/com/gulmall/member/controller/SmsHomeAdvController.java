...
import com.gulmall.member.excel.SmsHomeAdvExcel;
 ...
 */
@RestController
@RequestMapping("member/smshomeadv")
@Api(tags="首页轮播广告")
public class SmsHomeAdvController {
    ...
    @RequiresPermissions("member:smshomeadv:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("member:smshomeadv:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("member:smshomeadv:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("member:smshomeadv:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("member:smshomeadv:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("member:smshomeadv:export")
