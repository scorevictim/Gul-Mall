...
import com.gulmall.member.excel.SmsCouponSpuCategoryRelationExcel;
 ...
 */
@RestController
@RequestMapping("member/smscouponspucategoryrelation")
@Api(tags="优惠券分类关联")
public class SmsCouponSpuCategoryRelationController {
    ...
    @RequiresPermissions("member:smscouponspucategoryrelation:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("member:smscouponspucategoryrelation:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("member:smscouponspucategoryrelation:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("member:smscouponspucategoryrelation:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("member:smscouponspucategoryrelation:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("member:smscouponspucategoryrelation:export")
