...
import com.gulmall.member.excel.SmsSkuFullReductionExcel;
...
public class SmsSkuFullReductionController {
    ...
    @RequiresPermissions("member:smsskufullreduction:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("member:smsskufullreduction:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("member:smsskufullreduction:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("member:smsskufullreduction:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("member:smsskufullreduction:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("member:smsskufullreduction:export")
