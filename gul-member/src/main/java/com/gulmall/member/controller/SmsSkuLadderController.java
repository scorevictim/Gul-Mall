...
import com.gulmall.member.excel.SmsSkuLadderExcel;
 ...
 */
@RestController
@RequestMapping("member/smsskuladder")
@Api(tags="")
public class SmsSkuLadderController {
    ...
    @RequiresPermissions("member:smsskuladder:page")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("member:smsskuladder:export")
