...
import com.gulmall.member.excel.SmsCouponHistoryExcel;
...
public class SmsCouponHistoryController {
    ...
    @RequiresPermissions("member:smscouponhistory:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("member:smscouponhistory:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("member:smscouponhistory:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("member:smscouponhistory:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("member:smscouponhistory:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("member:smscouponhistory:export")
