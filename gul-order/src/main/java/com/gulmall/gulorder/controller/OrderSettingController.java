...
import com.gulmall.gulorder.dto.OrderSettingDTO;
import com.gulmall.gulorder.excel.OrderSettingExcel;
import com.gulmall.gulorder.service.OrderSettingService;
 ...
 */
@RestController
@RequestMapping("gulorder/ordersetting")
@Api(tags="订单配置信息")
public class OrderSettingController {
    ...
    @RequiresPermissions("gulorder:ordersetting:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulorder:ordersetting:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulorder:ordersetting:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulorder:ordersetting:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulorder:ordersetting:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulorder:ordersetting:export")
