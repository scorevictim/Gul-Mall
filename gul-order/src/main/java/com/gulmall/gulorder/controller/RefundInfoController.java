...
import com.gulmall.gulorder.excel.RefundInfoExcel;
 ...
 */
@RestController
@RequestMapping("gulorder/refundinfo")
@Api(tags="退款信息")
public class RefundInfoController {
    ...
    @RequiresPermissions("gulorder:refundinfo:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulorder:refundinfo:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulorder:refundinfo:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulorder:refundinfo:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulorder:refundinfo:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulorder:refundinfo:export")
