...
import com.gulmall.gulorder.dto.OrderReturnReasonDTO;
import com.gulmall.gulorder.excel.OrderReturnReasonExcel;
import com.gulmall.gulorder.service.OrderReturnReasonService;
 ...
 */
@RestController
@RequestMapping("gulorder/orderreturnreason")
@Api(tags="退货原因")
public class OrderReturnReasonController {
    ...
    @RequiresPermissions("gulorder:orderreturnreason:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulorder:orderreturnreason:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulorder:orderreturnreason:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulorder:orderreturnreason:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulorder:orderreturnreason:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulorder:orderreturnreason:export")
