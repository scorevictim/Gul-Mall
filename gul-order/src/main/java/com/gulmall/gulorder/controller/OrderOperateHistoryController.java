...
import com.gulmall.gulorder.dto.OrderOperateHistoryDTO;
import com.gulmall.gulorder.excel.OrderOperateHistoryExcel;
import com.gulmall.gulorder.service.OrderOperateHistoryService;
 ...
 */
@RestController
@RequestMapping("gulorder/orderoperatehistory")
@Api(tags="订单操作历史记录")
public class OrderOperateHistoryController {
    ...
    @RequiresPermissions("gulorder:orderoperatehistory:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulorder:orderoperatehistory:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulorder:orderoperatehistory:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulorder:orderoperatehistory:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulorder:orderoperatehistory:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulorder:orderoperatehistory:export")
