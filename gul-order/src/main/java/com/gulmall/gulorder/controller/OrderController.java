...
import com.gulmall.gulorder.excel.OrderExcel;
import com.gulmall.gulorder.service.OrderService;
...
public class OrderController {
    ...
    @RequiresPermissions("gulorder:order:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulorder:order:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulorder:order:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulorder:order:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulorder:order:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulorder:order:export")
