...
import com.gulmall.gulorder.excel.OrderItemExcel;
 ...
 */
@RestController
@RequestMapping("gulorder/orderitem")
@Api(tags="订单项信息")
public class OrderItemController {
    ...
    @RequiresPermissions("gulorder:orderitem:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulorder:orderitem:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulorder:orderitem:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulorder:orderitem:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulorder:orderitem:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulorder:orderitem:export")
