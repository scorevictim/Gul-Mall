...
import com.gulmall.gulware.excel.WmsWareSkuExcel;
 ...
 */
@RestController
@RequestMapping("gulware/wmswaresku")
@Api(tags="商品库存")
public class WmsWareSkuController {
    ...
    @RequiresPermissions("gulware:wmswaresku:page")
    public Result<PageData<WmsWareSkuDTO>> page(@ApiIgnore @RequestParam Map<String, Object> params){
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulware:wmswaresku:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulware:wmswaresku:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulware:wmswaresku:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulware:wmswaresku:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulware:wmswaresku:export")
    public void export(@ApiIgnore @RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        List<WmsWareSkuDTO> list = wmsWareSkuService.list(params);

        ExcelUtils.exportExcelToTarget(response, null, list, WmsWareSkuExcel.class);
    }
