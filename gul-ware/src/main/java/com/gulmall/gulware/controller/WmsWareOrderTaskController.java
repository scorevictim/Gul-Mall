...
import com.gulmall.gulware.dto.WmsWareOrderTaskDTO;
import com.gulmall.gulware.excel.WmsWareOrderTaskExcel;
import com.gulmall.gulware.service.WmsWareOrderTaskService;
 ...
 */
@RestController
@RequestMapping("gulware/wmswareordertask")
@Api(tags="库存工作单")
public class WmsWareOrderTaskController {
    ...
    @RequiresPermissions("gulware:wmswareordertask:page")
    public Result<PageData<WmsWareOrderTaskDTO>> page(@ApiIgnore @RequestParam Map<String, Object> params){
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulware:wmswareordertask:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulware:wmswareordertask:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulware:wmswareordertask:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulware:wmswareordertask:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulware:wmswareordertask:export")
    public void export(@ApiIgnore @RequestParam Map<String, Object> params, HttpServletResponse response) throws Exception {
        List<WmsWareOrderTaskDTO> list = wmsWareOrderTaskService.list(params);

        ExcelUtils.exportExcelToTarget(response, null, list, WmsWareOrderTaskExcel.class);
    }
