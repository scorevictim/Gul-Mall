...
import com.gulmall.gulcoupon.excel.CouponSpuRelationExcel;
 ...
 */
@RestController
@RequestMapping("gulcoupon/couponspurelation")
@Api(tags="优惠券与产品关联")
public class CouponSpuRelationController {
    ...
    @RequiresPermissions("gulcoupon:couponspurelation:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulcoupon:couponspurelation:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulcoupon:couponspurelation:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulcoupon:couponspurelation:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulcoupon:couponspurelation:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulcoupon:couponspurelation:export")
