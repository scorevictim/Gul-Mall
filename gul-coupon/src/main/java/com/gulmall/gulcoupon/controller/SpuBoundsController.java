...
import com.gulmall.gulcoupon.excel.SpuBoundsExcel;
 ...
 */
@RestController
@RequestMapping("gulcoupon/spubounds")
@Api(tags="商品spu积分设置")
public class SpuBoundsController {
    ...
    @RequiresPermissions("gulcoupon:spubounds:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulcoupon:spubounds:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulcoupon:spubounds:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulcoupon:spubounds:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulcoupon:spubounds:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulcoupon:spubounds:export")
