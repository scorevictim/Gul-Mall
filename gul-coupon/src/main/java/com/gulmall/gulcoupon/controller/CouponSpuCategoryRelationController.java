...
import com.gulmall.gulcoupon.excel.CouponSpuCategoryRelationExcel;
 ...
 */
@RestController
@RequestMapping("gulcoupon/couponspucategoryrelation")
@Api(tags="优惠券分类关联")
public class CouponSpuCategoryRelationController {
    ...
    @RequiresPermissions("gulcoupon:couponspucategoryrelation:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulcoupon:couponspucategoryrelation:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulcoupon:couponspucategoryrelation:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulcoupon:couponspucategoryrelation:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulcoupon:couponspucategoryrelation:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulcoupon:couponspucategoryrelation:export")
