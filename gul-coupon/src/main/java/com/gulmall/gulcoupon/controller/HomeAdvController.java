...
import com.gulmall.gulcoupon.dto.HomeAdvDTO;
import com.gulmall.gulcoupon.excel.HomeAdvExcel;
import com.gulmall.gulcoupon.service.HomeAdvService;
 ...
 */
@RestController
@RequestMapping("gulcoupon/homeadv")
@Api(tags="首页轮播广告")
public class HomeAdvController {
    ...
    @RequiresPermissions("gulcoupon:homeadv:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulcoupon:homeadv:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulcoupon:homeadv:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulcoupon:homeadv:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulcoupon:homeadv:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulcoupon:homeadv:export")
