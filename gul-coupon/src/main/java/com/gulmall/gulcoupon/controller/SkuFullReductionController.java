...
import com.gulmall.gulcoupon.dto.SkuFullReductionDTO;
import com.gulmall.gulcoupon.excel.SkuFullReductionExcel;
import com.gulmall.gulcoupon.service.SkuFullReductionService;
 ...
 */
@RestController
@RequestMapping("gulcoupon/skufullreduction")
@Api(tags="商品满减信息")
public class SkuFullReductionController {
    ...
    @RequiresPermissions("gulcoupon:skufullreduction:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulcoupon:skufullreduction:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulcoupon:skufullreduction:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulcoupon:skufullreduction:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulcoupon:skufullreduction:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulcoupon:skufullreduction:export")
