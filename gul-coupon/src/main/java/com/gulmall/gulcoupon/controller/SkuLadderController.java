...
import com.gulmall.gulcoupon.excel.SkuLadderExcel;
 ...
 */
@RestController
@RequestMapping("gulcoupon/skuladder")
@Api(tags="商品阶梯价格")
public class SkuLadderController {
    ...
    @RequiresPermissions("gulcoupon:skuladder:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulcoupon:skuladder:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulcoupon:skuladder:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulcoupon:skuladder:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulcoupon:skuladder:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulcoupon:skuladder:export")
