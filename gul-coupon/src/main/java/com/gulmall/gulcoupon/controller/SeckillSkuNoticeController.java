...
import com.gulmall.gulcoupon.excel.SeckillSkuNoticeExcel;
 ...
 */
@RestController
@RequestMapping("gulcoupon/seckillskunotice")
@Api(tags="秒杀商品通知订阅")
public class SeckillSkuNoticeController {
    ...
    @RequiresPermissions("gulcoupon:seckillskunotice:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulcoupon:seckillskunotice:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulcoupon:seckillskunotice:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulcoupon:seckillskunotice:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulcoupon:seckillskunotice:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulcoupon:seckillskunotice:export")
