...
import com.gulmall.gulcoupon.excel.HomeSubjectSpuExcel;
 ...
 */
@RestController
@RequestMapping("gulcoupon/homesubjectspu")
@Api(tags="专题商品")
public class HomeSubjectSpuController {
    ...
    @RequiresPermissions("gulcoupon:homesubjectspu:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulcoupon:homesubjectspu:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulcoupon:homesubjectspu:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulcoupon:homesubjectspu:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulcoupon:homesubjectspu:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulcoupon:homesubjectspu:export")
