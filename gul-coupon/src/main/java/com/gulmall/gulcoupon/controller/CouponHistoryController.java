...
import com.gulmall.gulcoupon.dto.CouponHistoryDTO;
import com.gulmall.gulcoupon.excel.CouponHistoryExcel;
import com.gulmall.gulcoupon.service.CouponHistoryService;
 ...
 */
@RestController
@RequestMapping("gulcoupon/couponhistory")
@Api(tags="优惠券领取历史记录")
public class CouponHistoryController {
    ...
    @RequiresPermissions("gulcoupon:couponhistory:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulcoupon:couponhistory:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulcoupon:couponhistory:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulcoupon:couponhistory:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulcoupon:couponhistory:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulcoupon:couponhistory:export")
