...
import com.gulmall.gulproduct.excel.CategoryExcel;
 ...
 */
@RestController
@RequestMapping("gulproduct/category")
@Api(tags="商品三级分类")
public class CategoryController {
    ...
    @RequiresPermissions("gulproduct:category:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulproduct:category:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulproduct:category:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulproduct:category:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulproduct:category:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulproduct:category:export")
