...
import com.gulmall.gulproduct.excel.SpuCommentExcel;
 ...
 */
@RestController
@RequestMapping("gulproduct/spucomment")
@Api(tags="商品评价")
public class SpuCommentController {
    ...
    @RequiresPermissions("gulproduct:spucomment:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulproduct:spucomment:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulproduct:spucomment:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulproduct:spucomment:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulproduct:spucomment:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulproduct:spucomment:export")
