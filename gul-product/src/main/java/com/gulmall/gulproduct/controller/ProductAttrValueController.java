...
import com.gulmall.gulproduct.excel.ProductAttrValueExcel;
 ...
 */
@RestController
@RequestMapping("gulproduct/productattrvalue")
@Api(tags="spu属性值")
public class ProductAttrValueController {
    ...
    @RequiresPermissions("gulproduct:productattrvalue:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulproduct:productattrvalue:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulproduct:productattrvalue:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulproduct:productattrvalue:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulproduct:productattrvalue:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulproduct:productattrvalue:export")
