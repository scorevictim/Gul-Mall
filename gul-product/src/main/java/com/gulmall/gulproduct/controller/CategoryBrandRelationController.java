...
import com.gulmall.gulproduct.excel.CategoryBrandRelationExcel;
 ...
 */
@RestController
@RequestMapping("gulproduct/categorybrandrelation")
@Api(tags="品牌分类关联")
public class CategoryBrandRelationController {
    ...
    @RequiresPermissions("gulproduct:categorybrandrelation:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulproduct:categorybrandrelation:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulproduct:categorybrandrelation:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulproduct:categorybrandrelation:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulproduct:categorybrandrelation:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulproduct:categorybrandrelation:export")
