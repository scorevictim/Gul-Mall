...
import com.gulmall.gulproduct.excel.SkuInfoExcel;
 ...
 */
@RestController
@RequestMapping("gulproduct/skuinfo")
@Api(tags="sku信息")
public class SkuInfoController {
    ...
    @RequiresPermissions("gulproduct:skuinfo:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulproduct:skuinfo:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulproduct:skuinfo:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulproduct:skuinfo:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulproduct:skuinfo:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulproduct:skuinfo:export")
