...
import com.gulmall.gulproduct.excel.SpuInfoDescExcel;
 ...
 */
@RestController
@RequestMapping("gulproduct/spuinfodesc")
@Api(tags="spu信息介绍")
public class SpuInfoDescController {
    ...
    @RequiresPermissions("gulproduct:spuinfodesc:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulproduct:spuinfodesc:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulproduct:spuinfodesc:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulproduct:spuinfodesc:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulproduct:spuinfodesc:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulproduct:spuinfodesc:export")
