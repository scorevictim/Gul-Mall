...
import com.gulmall.gulproduct.excel.BrandExcel;
 ...
 */
@RestController
@RequestMapping("gulproduct/brand")
@Api(tags="品牌")
public class BrandController {
    ...
    @RequiresPermissions("gulproduct:brand:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulproduct:brand:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulproduct:brand:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulproduct:brand:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulproduct:brand:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulproduct:brand:export")
