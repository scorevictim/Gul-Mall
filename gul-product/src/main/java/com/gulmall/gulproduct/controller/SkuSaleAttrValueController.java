...
import com.gulmall.gulproduct.excel.SkuSaleAttrValueExcel;
 ...
 */
@RestController
@RequestMapping("gulproduct/skusaleattrvalue")
@Api(tags="sku销售属性&值")
public class SkuSaleAttrValueController {
    ...
    @RequiresPermissions("gulproduct:skusaleattrvalue:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulproduct:skusaleattrvalue:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulproduct:skusaleattrvalue:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulproduct:skusaleattrvalue:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulproduct:skusaleattrvalue:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulproduct:skusaleattrvalue:export")
