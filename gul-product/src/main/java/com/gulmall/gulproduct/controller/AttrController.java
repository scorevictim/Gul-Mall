...
import com.gulmall.gulproduct.excel.AttrExcel;
 ...
 */
@RestController
@RequestMapping("gulproduct/attr")
@Api(tags="商品属性")
public class AttrController {
    ...
    @RequiresPermissions("gulproduct:attr:page")
    ...
    @GetMapping("{id}")
    @ApiOperation("信息")
    @RequiresPermissions("gulproduct:attr:info")
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    @RequiresPermissions("gulproduct:attr:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    @RequiresPermissions("gulproduct:attr:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    @RequiresPermissions("gulproduct:attr:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    @RequiresPermissions("gulproduct:attr:export")
